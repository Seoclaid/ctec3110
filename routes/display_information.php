...
require_once __DIR__ . '/wrappers/MySQL_Wrapper.php';                       //variable information is then used for concatenating with the required
require_once __DIR__ . '/../src/DataDisplayModel.php';                      //php files which are required_once and loaded
require_once __DIR__ . '/../src/ValidateModel.php';

require_once $f_wrapper_path . 'Session_Wrapper.php';
require_once $f_wrapper_path . 'MCrypt_Wrapper.php';
require_once __DIR__ . '/../src/AppLoggerModel.php';
