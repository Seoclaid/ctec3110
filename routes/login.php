<?php
// application/app/routes/login.php
...
require_once __DIR__ . '/../controllers/classes/LoginModel.php';                            //php files which are required_once and loaded
require_once __DIR__ . '/../controllers/classes/SessionModel.php';
require_once __DIR__ . '/../controllers/classes/AppLoggerModel.php';

require_once __DIR__ . '/wrappers/Session_Wrapper.php';
require_once __DIR__ . '/wrappers/MySQL_Wrapper.php';
